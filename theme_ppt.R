...
# modify hrbrthemes theme ipsum 
theme_ppt = function(base_family = "Arial", # Arial Narrow
          base_size = 14 , # 11.5
          plot_title_family = base_family, 
          plot_title_size = 32, #18 
          plot_title_face = "bold", 
          plot_title_margin = 10, subtitle_family = base_family, subtitle_size = 12, 
          subtitle_face = "bold",  # plain
          subtitle_margin = 15, strip_text_family = base_family, 
          strip_text_size = 12, strip_text_face = "plain", caption_family = base_family, 
          caption_size = 9, caption_face = "italic", caption_margin = 10, 
          axis_text_size = base_size,
          axis_text_family = "bold" , #new
          axis_title_family = subtitle_family, 
          axis_title_size = 9,
          axis_title_face = "bold", # plain
          axis_title_just = "rt", 
